...
('Princess', 'https://res.cloudinary.com/dwjrv71xr/image/upload/v1676013180/download_afso6t.jpg',103, 'D', 'IF', 'Excellent', 2700, true),
('Round', 'https://res.cloudinary.com/dwjrv71xr/image/upload/v1676013180/round-diamond_gi6tf7.jpg',102, 'I', 'VS1', 'Ideal', 5000, true),
('Cushion', 'https://res.cloudinary.com/dwjrv71xr/image/upload/v1676013180/cushion-diamond_tdo0gx.jpg',101, 'I', 'VVS2', 'Very Good', 3000, true),
('Pear', 'https://res.cloudinary.com/dwjrv71xr/image/upload/v1676013180/pear-diamond_wzcmq5.jpg',040, 'J', 'SI1', 'Good', 417, true),
...
('Oval', 'https://res.cloudinary.com/dwjrv71xr/image/upload/v1676013180/oval-diamond_zlsijd.jpg',023, 'F', 'VVS1', 'Very Good', 322, true),
('Marquise', 'https://res.cloudinary.com/dwjrv71xr/image/upload/v1676013180/marquise-diamond_knardq.jpg',030, 'E', 'VS2', 'Very Good', 759, true),
('Radiant', 'https://res.cloudinary.com/dwjrv71xr/image/upload/v1676013180/radiant-diamond_co0ey5.jpg',032, 'G', 'IF', 'Very Good', 441, true),
